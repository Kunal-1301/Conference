    ...
    technical: [
        {
            ...
            members: [
                { name: 'Dr. M Waris Abdullah', img: './dummy.jpg', position: 'Qualcomm, Cambridge, UK' },
                { name: 'Abhishek Srivastava', img: './dummy.jpg', position: 'Associate Professor Ph.D, IIT Bombay, India' },
                { name: 'Dr. Hemant Kumar Meena', img: './dummy.jpg', position: 'Electrical Engineering, MNIT Jaipur, Jaipur, India' },
                { name: 'Sujay Deb', img: './dummy.jpg', position: 'Ph.D. (2012), Washington State University, USA' },
